...
with app.app_context():
    ...
    heropower2 = HeroPower(hero =hero4, power =power4, strength = "Average")
    heropower3 = HeroPower(hero=hero2, power=power2, strength = "Weak")
    heropower4 = HeroPower(hero=hero3, power=power3, strength = "Strong")
    heropower5 = HeroPower(hero=hero5, power=power5, strength= "Weak")
